...
WIDGETS = {
        'splash': { 'type':'text', 'format':'     moOdeAudio     \n Network DAC Player ', 'font':'small' },
...
#       'tracktype': { 'type':'text', 'format':'{0}', 'variables':['tracktype'], 'font':'small','varwidth':True,'effect':('scroll','left',5,2,10,'onstart',1,70) },
        ...
        'time': { 'type':'text', 'format':'{0}', 'variables':['localtime|strftime+%-I:%M'], 'font':'small', 'just':'right', 'varwidth':True, 'size':(55,16) },
        ...
        'temptoohigh': { 'type':'text', 'format':'\ue005 Warning System Too Hot ({0})', 'variables':['system_temp_formatted'], 'font':'large', 'varwidth':True, 'effect':('scroll','left',5,1,20,'onstart',3,8$
}
...
CANVASES = {
#        'playartist1': { 'widgets': [ ('artist',0,0), ('title',0,8), 'size':(100,16) },
#       'playtitle1': { 'widgets': [ ('artist',0,0), ('playstopsymbol',0,8), ('nowplayingdata',65,8), ('remaining',10,8) ], 'size':(100,16) },

        'playartist1': { 'widgets': [ ('artist',0,0), ('playstopsymbol',0,8), ('nowplayingdata',65,8), ('remaining',10,8) ], 'size':(100,16) },
        'playtitle1': { 'widgets': [ ('title',0,0), ('playstopsymbol',0,8), ('remaining',10,8), ('nowplayingdata',65,8) ], 'size':(100,16) },
#       'playtitle1': { 'widgets': [ ('title',0,0), ('playstopsymbol',0,8), ('remaining',10,8), ('nowplayingdata',65,8) ], 'size':(100,16) },
...
#       'playtitle2': { 'widgets':  [ ('title',0,0), ('playstopsymbol',0,8),('remaining',10,8), ('nowplayingdata',65,8) ], 'size':(100,16) },
        ...
        'stoptime': { 'widgets': [ ('time',0,0), ('ampm',60,0) ], 'size':(100,16) },
...
SEQUENCES = [
        {       'name': 'seqSplash', 'canvases': [ { 'name':'splash', 'duration':4 } ], 'conditional':"db['state']=='starting'"   },
        {
                'name': 'seqPlay',
                'canvases': [
#                        { 'name':'playartisttitle', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
#                        { 'name':'playartist', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
                        { 'name':'playartist1', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
                        { 'name':'playtitle1', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
#                       { 'name':'playartist2', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
#                       { 'name':'playtitle2', 'duration':12, 'conditional':"not db['encoding']=='webradio'" },
                        { 'name':'playartist_radio', 'duration':12, 'conditional':"db['encoding']=='webradio'" },
                        { 'name':'playalbum_radio', 'duration':12, 'conditional':"db['encoding']=='webradio' and db['album']" },
                        { 'name':'playtitle_radio', 'duration':12, 'conditional':"db['encoding']=='webradio'" },
                ],
